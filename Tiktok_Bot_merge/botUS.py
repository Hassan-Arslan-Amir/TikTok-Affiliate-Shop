...
def openchrome(username, shop_id, max_retries=2):
            ...
            if isinstance(cookies, list) and all(isinstance(c, dict) for c in cookies):
                ...
                for cookie in cookies:
                    try:
                        ...
                        logging.warning(f"⚠️ Skipping malformed cookie: {ce}")
...
def get_overlap_count(driver):
    ...
    try:
        ...
        overlap_text_element = WebDriverWait(driver, 20).until(
...
#------------ In case of open collab
    if bot_choice == "2":
        import traceback
        from US_batch_message import run_mainfunction_periodically
        try:
    ...
    while True:
        ...
        try :
            while True:
                ...
                try:
                    ...
                    # handleHomepopup(driver)
                    driver.get(
                        "https://affiliate-us.tiktok.com/connection/target-invitation?shop_region=US&tab=1"
                    )
        ...
        #--------------------------------------------------------------------------------#
                        try:
                            ...
                            colabtbn = WebDriverWait(driver, 20).until(
                        ...
                        try:
                            findcreatorbtn = WebDriverWait(driver, 10).until(
                        ...
                        try:
                            findcreatorbtn = WebDriverWait(driver, 5).until(
        ...
        #---------------------------------------- Create Invitation -------------------------------------------------------#  
                    ...
                    createinvitebtn = WebDriverWait(driver, 10).until(
        ...
        #------------------ Step 1: Click Send
                            ...
                            try:
                                ...
                                for _ in range(MAX_RETRIES):
                                    try:
                                        resolve_btn = WebDriverWait(driver, 10).until(
        ...
        #------------------- Clicking the share button ont the pop up.
                            sharebtn = WebDriverWait(driver, 20).until(
                            ...
                            if sharebtn.is_displayed() and sharebtn.is_enabled():
                                ...
                                try: 
                                    ...
                                    try:
                                        ...
                                        logging.info("Share button clicked using JavaScript")
                                    except Exception as js_e:
                                        logging.error("Even JavaScript click failed:", str(js_e))
        ...
        #------------------ Switch back to original tab (do NOT close share tab)
                                ...
                                time.sleep(2)  # Small delay before next user
                            else:
